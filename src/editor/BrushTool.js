...
export class BrushTool {
    ...
    applyHill(hit) {
        ...
        if (this._normalUpdateCounter % 3 === 0) {
    ...
    applyTexture(hit, renderer) {
        ...
        this.terrainMesh.paintAt(uv, radius, this.strength, false, renderer);
    }
    ...
    applyEraseTexture(hit, renderer) {
        ...
        const uv = this.terrainMesh.worldPointToUV(hit.point);
        const radius = this._getRadius() / this.terrainMesh.gridSize;
        this.terrainMesh.paintAt(uv, radius, this.strength, true, renderer);
    }
